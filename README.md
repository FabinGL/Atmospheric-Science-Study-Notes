...
\hline
预测                       &                &                        & 实况                    &                 &                          &                \\ \hline
                         & $B \geq 50 $\% & $50$\% $> B \geq 20$\% & $20$\% $> B \geq 0$\% & $0 > B > -20$\% & $-20$\% $\gep B > -50$\% & $B \leq -50$\% \\ \hline
$A \geq 50 $\%           & √              & √                      & √                     & ×               & ×                        & ×              \\ \hline
$50$\% $> A \geq 20$\%   & √              & √                      & √                     & ×               & ×                        & ×              \\ \hline
$20$\% $> A \geq 0$\%    & √              & √                      & √                     & ×               & ×                        & ×              \\ \hline
$0 > A > -20$\%          & ×              & ×                      & ×                     & √               & √                        & √              \\ \hline
...
6. 使用公式 $Ps=100*(A*N_0+B*N_1+C*N_2)/(N-N_0+A*N_0+B*N_1+C*N_2+M)$，其中a、b和c分别为气候趋势项、一级异常项和二级异常项的权重系数，本办法分别取a=2，b=2，c=4。
